...
# 2. Extracting Data
# 3. Data cleaning
# - 3.1 Extracting Ask HN and Show HN Posts
# 4. Data Analysis
# - 4.1 Calculating the Average Number of Comments for Ask HN and Show HN Posts
# - 4.2 Finding the Number of Ask Posts and Comments by Hour Created
# 5. Conclusion
# 6. Recommendation
